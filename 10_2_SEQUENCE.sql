...
-- 223번 부터 10씩 증가하는 시퀀스 생성하기
CREATE SEQUENCE SEQ_TEMP
START WITH 223 -- 223번부터 시작
INCREMENT BY 10 -- 10씩 증가
NOCYCLE         -- 반복 X (기본값)
NOCACHE;        -- 캐시 X (CHACHE 20 기본값)

-- EMP_TEMP 테이블에 사원 정보 삽입

INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '이현경'); -- 223

SELECT * FROM EMP_TEMP;

INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '김덕근'); -- 233
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '오가람'); -- 243
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '김준수'); -- 244
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '위지은'); -- 245
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '최정오'); -- 246
